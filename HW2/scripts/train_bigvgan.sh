...
#SBATCH --output=/work/jgtf0322/Homework/2023-Fall-DLMAG/HW2/logs/bigvgan_pretrained_spec_norm.log

cd /work/jgtf0322/Homework/2023-Fall-DLMAG/HW2/bigvgan

python train.py \
    --config ./configs/bigvgan_22khz_80band.json \
    --checkpoint_path /work/jgtf0322/Homework/2023-Fall-DLMAG/HW2/exp/bigvgan_pretrained_spec_norm \
