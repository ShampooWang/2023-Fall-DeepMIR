...
def add_general_arguments(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--resume_ckpt", type=str, default="", help="Checkpoint to resume.")

    # Hparams
    parser.add_argument("--device", type=str, default="cuda:0", help="Device name, could be cuda:X or cpu")
